...
Requirements:
    pip install pystac pystac-client jsonschema
"""
...
# ---------------------------------------------------------------------------
# 2. Helper: extract all health fields from an Item
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 6. Semantic search helper for LLM integration
# ---------------------------------------------------------------------------
...
# Example: "Find all open vector data for Germany"
results = search_items_by_health(
    all_items, data_type="vector_occurrence", country="DEU", access_level=None
)
print("\n=== Search: vector_occurrence in DEU ===")
for it in results:
    print(f"  {it.id}")

# Example: "Find datasets related to West Nile Virus"
...
# Example: build a prompt for an LLM
